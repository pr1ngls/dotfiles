-- NOTE: you dont need to require all this stuff
-- this dynamicly links when loads in luasnip.lua
-- check luasnip doc.md and snip_env
...
-- NOTE: check luasnip wiki https://github.com/L3MON4D3/LuaSnip/wiki/Misc#mathematical-context-detection-for-conditional-expansion-without-relying-on-vimtexs-in_mathzone
-- what if u wanna use math snippets in markdown files
local tex = {}
...
-- TODO: pls refactor this, use tables for different snippets groups
-- NOTE: check extend_decorator
-- also you can use parse() for basic snippets
return {
  s({ trig = "ls" }, {
    t({ "\\begin{itemize}",
      "\t\\item " }), i(1), d(2, rec_ls, {}),
